...
- Name: tier1.spec.ts >> F4: Admin Auth, Security & Rate-limiting >> Test 4.2: Verify logging in with correct credentials allows access to protected "/admin" routes
- Location: tests\tier1.spec.ts:366:7
