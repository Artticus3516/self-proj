...
- Name: tier1.spec.ts >> F4: Admin Auth, Security & Rate-limiting >> Test 4.5: Verify Next.js App Router middleware/proxy protects "/api/admin/*" API endpoints (if any) or admin page handlers from anonymous requests
- Location: tests\tier1.spec.ts:416:7
...
Expected value: 404
Received array: [401, 403, 302, 307]
```
