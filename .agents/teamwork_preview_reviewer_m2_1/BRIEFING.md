...
Review the database schema, Supabase mock client, and proxy middleware for M2 correctness, safety, and project
conformance.
...
- **Vulnerabilities found**:
    ...
    - Mock client write-select mismatch (returns data from insert/update/delete without select, violating real Supabase
      API contract).
