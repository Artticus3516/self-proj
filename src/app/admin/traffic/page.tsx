                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm">
                            ...
                            <tr className="border-b border-zinc-800 text-left">
                                ...
                                <th className="px-5 py-3 text-xs font-medium text-zinc-500 uppercase tracking-wider">User
                                    Agent
                                </th>
                            ...
                            {logs.map((log) => (
                                ...
                                >
                                    ...
                                    <td className="px-5 py-3">
                                        {log.consent_granted ? (
                                            <span
                                                className="inline-flex items-center gap-1 rounded-full bg-emerald-950/60 border border-emerald-800/50 px-2.5 py-0.5 text-[10px] font-medium text-emerald-400">
                          ✓ Granted
                        </span>
                                        ) : (
                                            <span
                                                className="inline-flex items-center gap-1 rounded-full bg-red-950/60 border border-red-800/50 px-2.5 py-0.5 text-[10px] font-medium text-red-400">
                          ✕ Denied
                        </span>
                                        )}
                                    </td>
